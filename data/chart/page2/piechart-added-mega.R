...
chart1 <- create_pie_chart(c(0.43, 1.2), c(green, blue), "Nov 2020 to May 2024")
chart2 <- create_pie_chart(c(0.49, 1.60), c(green, blue), "Nov 2016 to Nov 2020")
chart3 <- create_pie_chart(c(0.41, 1.28), c(green, blue), "Nov 2012 to Nov 2016")
chart4 <- create_pie_chart(c(0.41, 1.22), c(green, blue), "Nov 2008 to Nov 2012")
